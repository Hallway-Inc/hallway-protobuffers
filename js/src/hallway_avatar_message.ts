  ...
  toJSON(message: HallwayAvatarPrediction): unknown {
    ...
    message.blendShapes !== undefined &&
      (obj.blendShapes = message.blendShapes
        ? BlendShapes.toJSON(message.blendShapes)
        : undefined);
...
export const BlendShapes = {
  ...
  fromJSON(object: any): BlendShapes {
    return {
      ...
      eyeLookDown_L: isSet(object.eyeLookDown_L)
        ...
        : 0,
      eyeLookDown_R: isSet(object.eyeLookDown_R)
        ? Number(object.eyeLookDown_R)
        : 0,
      ...
      eyeLookOut_L: isSet(object.eyeLookOut_L)
        ? Number(object.eyeLookOut_L)
        : 0,
      ...
      mouthLowerDown_L: isSet(object.mouthLowerDown_L)
        ...
        : 0,
      mouthLowerDown_R: isSet(object.mouthLowerDown_R)
        ? Number(object.mouthLowerDown_R)
        : 0,
      mouthPress_L: isSet(object.mouthPress_L)
        ? Number(object.mouthPress_L)
        : 0,
  ...
  toJSON(message: BlendShapes): unknown {
    ...
    message.eyeLookDown_R !== undefined &&
      (obj.eyeLookDown_R = message.eyeLookDown_R);
    message.eyeLookIn_L !== undefined &&
      (obj.eyeLookIn_L = message.eyeLookIn_L);
    message.eyeLookIn_R !== undefined &&
      (obj.eyeLookIn_R = message.eyeLookIn_R);
    message.eyeLookOut_L !== undefined &&
    ...
    message.mouthLowerDown_R !== undefined &&
      (obj.mouthLowerDown_R = message.mouthLowerDown_R);
    message.mouthPress_L !== undefined &&
  ...
  fromPartial<I extends Exact<DeepPartial<BlendShapes>, I>>(
    object: I
  ): BlendShapes {
    const message = createBaseBlendShapes();
